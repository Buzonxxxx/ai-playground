...
class CAMELAgent:
    ...
    def step(self, input_message: HumanMessage) -> AIMessage:
        ...
        output_message = self.model.invoke(messages)  # Use invoke instead of __call__
...
task_specify_agent = CAMELAgent(task_specifier_sys_msg, ChatOpenAI(model_name = 'gpt-4o', temperature=1.0))
